...
public class KeyframeUtil {
	class KeyframeWrap{
		...
		public static KeyframeWrap getNew(float time, float value){
			KeyframeWrap wrap = new KeyframeWrap();
			wrap.keyframe = new Keyframe(time, value);
			return wrap;
		}
	}
	...
	public static Keyframe GetNew(float time, float value, TangentMode left, TangentMode right){
		object boxed =(object)new Keyframe(time,value);
